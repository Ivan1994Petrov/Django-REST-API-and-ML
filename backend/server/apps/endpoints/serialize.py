...
class EndpointSerialize(serializers.ModelSerializer):
    class Meta:
        model = Endpoint
        read_only_fields = ('id', 'name', 'owner', 'created_ad')
        fields = read_only_fields


class MLAlgorithmSerialize(serializers.ModelSerializer):
...
class MLAlgorithmStatusSerialize(serializers.ModelSerializer):
    class Meta:
...
class MLRequestSerialize(serializers.ModelSerializer):
    class Meta:
        model = MLRequest
        read_only_fields = (
            "id",
